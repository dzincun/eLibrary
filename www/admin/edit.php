  ...
  <!-- Content wrapper div starts here-->
   ...
   <p align="right"> <a href="javascript:history.go(-1)">Назад</a> || <a href="admin.php">Главная</a></p>
      <h1>Страница библиотекаря<br />
          ...
          <p><?php echo '<a href="list_book_process.php">Книга</a>' ?></p>
          <p><?php echo '<a href="list_author_process.php">Автор</a>' ?></p>
          <!--<p><?php echo '<a href="list_publisher_process.php">Публикатор</a>' ?></p>-->
          <p><?php echo '<a href="list_subject_process.php">Категория</a>' ?></p>
    </div>
